...
public class Loan {
	...
	private String phoneNumber;
	 ...
	 @NotEmpty(message="anual_incom cannot be empty")
	...
	public Loan(long loanId, @NotEmpty(message = "applicant_name cannot be empty") String applicant_name,
				...
				Date birth_date, @NotEmpty(message = "id_type cannot be empty") String id_type,
				...
				@NotEmpty(message = "place_of_wor cannot be empty") String place_of_work,
				@NotEmpty(message = "job_title cannot be empty") String job_title,
				@NotEmpty(message = "anual_incom cannot be empty") String anual_income, int loanAmount, String loanType,
